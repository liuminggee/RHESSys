                                 ...
                                 int verbose_flag)
{
    ...
    //2. The soil leaching and surface outflow go to streamflow
    ...
    //10022025LML Mass balance check: streamflow total N balansed with
    //changes in surface & soil pool
    double init_streamN = patch[0].streamflow_NH4 +
                          patch[0].streamflow_NO3 +
                          patch[0].streamflow_DON;
    double init_surfN = patch[0].surface_NH4 +
                        patch[0].surface_DON +
                        patch[0].surface_NO3;
...
#endif
    //Checl N balance
    double end_streamN =  patch[0].streamflow_NH4 +
                          patch[0].streamflow_NO3 +
                          patch[0].streamflow_DON;
    double end_surfN = patch[0].surface_NH4 +
                        patch[0].surface_DON +
                        patch[0].surface_NO3;
    double flux_soil_N = patch[0].soil_ns.NH4_Qout +
                         patch[0].soil_ns.NO3_Qout +
                         patch[0].soil_ns.DON_Qout;
    double patch_N_balance = (end_streamN - init_streamN) +
                             (end_surfN - init_surfN) -
                             flux_soil_N;
    if (fabs(patch_N_balance) > 1.e-12) {
