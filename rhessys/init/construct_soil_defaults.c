...
*/
        ...
        defobj[0].NO3_adsorption_rate =	getDoubleParam(&paramCnt, &paramPtr, "NO3_adsorption_rate", "%lf", 0.000001, 1); //09222025LML increased to 20% of NH4 rate
        defobj[0].N_decay_rate = 	getDoubleParam(&paramCnt, &paramPtr, "N_decay", "%lf", 0.12, 1);

        defobj[0].denitrification_maxrate_adj = 	getDoubleParam(&paramCnt, &paramPtr, "denitrification_maxrate_adj", "%lf", 0.01, 1);   //09092025LML the original denitrification rate the very high. May need adjust
        defobj[0].nitrification_maxrate_adj = 	getDoubleParam(&paramCnt, &paramPtr, "nitrification_maxrate_adj", "%lf", 0.075, 1);   //09092025LML the original denitrification rate the very high. May need adjust
