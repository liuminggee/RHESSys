													 ...
													 struct	default_object	*defaults)
{
    ...
    canopy_strata[0].cs.maximum_live_biomass_this_year = 0.;
    ...
    //printf("canopy_strata[0].ID:%d\n    canopy_strata[0].veg_parm_ID:%d\n",canopy_strata[0].ID,canopy_strata[0].veg_parm_ID);
    ...
    canopy_strata[0].acc_year.mr = 0.0;                                         //06012022LML
    canopy_strata[0].acc_year.gr = 0.0;                                         //06012022LML
