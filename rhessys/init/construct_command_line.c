		...
		if ( i< main_argc ){
      	...
      	/*--------------------------------------------------------------*/
            ...
            /*-------------------------------------------------*/
                ...
                if (((command_line[0].fire_pspread < 0 && command_line[0].fire_understory_mortality_rate < 0)) ||
                    ((command_line[0].fire_pspread >= 0 && command_line[0].fire_understory_mortality_rate >= 0)))
                {
