												   ...
												   
{
	...
	for (i=0 ; i<num_default_files; i++) {
        ...
        //09182025LML
        default_object_list[i].epc.Mort_annual_max = getDoubleParam(&paramCnt, &paramPtr, "epc.Mort_annual_max", "%lf", 0.1, 1);
        default_object_list[i].epc.k_mort = getDoubleParam(&paramCnt, &paramPtr, "epc.k_mort", "%lf", 0.3, 1);
        default_object_list[i].epc.Mid_mort_stemc = getDoubleParam(&paramCnt, &paramPtr, "epc.Mid_mort_stemc", "%lf", 20.0, 1);
        ...
        default_object_list[i].epc.alloc_frootc_crootc 	 = getDoubleParam(&paramCnt, &paramPtr, "epc.alloc_frootc_crootc", "%lf", 1.0, 1); //04092025LML
...
//#endif
        ...
        default_object_list[i].epc.min_percent_leafg = getDoubleParam(&paramCnt, &paramPtr, "epc.min_percent_leafg", "%lf", 0.2,1);  //1216LML default_object_list[i].epc.leaf_turnover, 1);
        ...
        //02132024
        default_object_list[i].epc.allomatric_c = getDoubleParam(&paramCnt, &paramPtr, "epc.allomatric_c", "%lf", 1.765, 1);
        default_object_list[i].epc.allomatric_d = getDoubleParam(&paramCnt, &paramPtr, "epc.allomatric_d", "%lf", 0.667, 1);
	/*--------------------------------------------------------------*/
