...
int update_nitrif(
                  ...
                  double nitrif_prop,
                  double std,
                  double nitrification_maxrate_adj)
{
    /*------------------------------------------------------*/
    ...
    if ((ns_soil->sminn > ZERO)) {
        ...
        max_nit_rate = kg_soil * MAX_RATE * 0.000001 * nitrification_maxrate_adj; //10012025LML kgN/m2
        /*--------------------------------------------------------------*/
        ...
        //10012025LML
        nitrify = water_scalar * T_scalar * N_scalar * pH_scalar * max_nit_rate; //(kgN/m2/day) 09222025LML original max nitrification rate is too high and the original equation seems not correct!
