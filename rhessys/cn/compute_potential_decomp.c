                             ...
                             )
{
    ...
    if (tsoil < -10.0){
        ...
        //10012025LML double beta = log(q10)/10.0;
        //10012025LML t_scalar = exp(beta * (tsoil - 10.));
    }
    ...
    if (patch[0].soil_defaults[0][0].decom_model == 1
        || patch[0].soil_defaults[0][0].decom_model == 2) {
