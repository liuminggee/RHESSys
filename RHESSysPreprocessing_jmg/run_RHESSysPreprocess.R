...
setwd("C:/Ubuntu/research/rhessys/preprocessing")
...
typepars = "./input_data/input_cleaned"
...
template = "input_data/input_cleaned/templates/template_bullrun"
...
name = "create_input_files/output_worldfiles/bullrun"
